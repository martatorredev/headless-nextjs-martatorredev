const TITLE = "What i do (and what i don't)";
const DESCRIPTION =
  "I am autonomous, perfectionist and very selective with the development projects in which I am involved.";

const items = [
  {
    image: "/headless/assets/crown.svg",
    title: "I am commited to specialization and teamwork",
    description:
  ...
  {
    image: "/headless/assets/dollar.svg",

    title: "My training, quality and results are worth what they are worth",
    description:
  ...
  {
    image: "/headless/assets/message.svg",

    title: "I like to speak clearly, without technicalities or detours",
    description:
  ...
  {
    image: "/headless/assets/light.svg",

    title: "When I start a project, I give it my all",
    description:
...
export { TITLE, DESCRIPTION, items };
